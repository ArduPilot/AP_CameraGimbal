...
static ot_isp_sns_commbus imx586_bus[OT_ISP_MAX_PIPE_NUM] = {
    [0] = { .i2c_dev = 0 },
    [1 ... OT_ISP_MAX_PIPE_NUM - 1] = { .i2c_dev = -1 },
};
static int imx586_i2c_fd[OT_ISP_MAX_PIPE_NUM] = {
    [0 ... OT_ISP_MAX_PIPE_NUM - 1] = -1,
};
...
{
    return vi_pipe >= 0 && vi_pipe < OT_ISP_MAX_PIPE_NUM;
}
...
static td_s32 imx586_get_isp_default(ot_vi_pipe vi_pipe, ot_isp_cmos_default *def)
{
    ...
    _Static_assert(sizeof(def->dng_color_param) == sizeof(imx586_dng_color), "B090 DNG color ABI drift");
...
static td_s32 imx586_get_black_level(ot_vi_pipe vi_pipe, ot_isp_cmos_black_level *black_level)
{
    ...
    _Static_assert(sizeof(*black_level) == sizeof(imx586_linear_black_level), "B090 black-level ABI drift");
...
static td_s32 imx586_get_awb_default(ot_vi_pipe vi_pipe, ot_isp_awb_sensor_default *awb_default)
{
    ...
    _Static_assert(sizeof(awb_default->agc_tbl) == sizeof(imx586_awb_agc), "B090 AWB AGC ABI drift");
    _Static_assert(sizeof(awb_default->ccm) == sizeof(imx586_awb_ccm), "B090 AWB CCM ABI drift");
    ...
    ot_isp_3a_alg_lib *awb_lib)
{
    ...
    if (imx586_state[vi_pipe] == TD_NULL) {
        imx586_state[vi_pipe] = calloc(1, sizeof(*imx586_state[vi_pipe]));
        if (imx586_state[vi_pipe] == TD_NULL) {
