...
SIYI vendor ports increase by one per slot; Z1-Mini UDP command ports increase
by ten to leave the fixed UDP reply port 2338 available to clients. Fresh configurations also have distinct
